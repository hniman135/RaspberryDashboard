...
<br>
<div align="center">
  <a href="https://github.com/hniman135/RaspberryDashboard/stargazers"><img src="https://img.shields.io/github/stars/hniman135/RaspberryDashboard?color=yellow" alt="Stars Badge"/></a>
<a href="https://github.com/hniman135/RaspberryDashboard/network/members"><img src="https://img.shields.io/github/forks/hniman135/RaspberryDashboard?color=orange" alt="Forks Badge"/></a>
<a href="https://github.com/hniman135/RaspberryDashboard/pulls"><img src="https://img.shields.io/github/issues-pr/hniman135/RaspberryDashboard" alt="Pull Requests Badge"/></a>
<a href="https://github.com/hniman135/RaspberryDashboard/issues"><img src="https://img.shields.io/github/issues/hniman135/RaspberryDashboard" alt="Issues Badge"/></a>
<a href="https://github.com/hniman135/RaspberryDashboard/graphs/contributors"><img alt="GitHub contributors" src="https://img.shields.io/github/contributors/hniman135/RaspberryDashboard?color=2b9348"></a>
<a href="https://github.com/hniman135/RaspberryDashboard/blob/master/LICENSE"><img src="https://img.shields.io/github/license/hniman135/RaspberryDashboard?color=2b9348" alt="License Badge"/></a>
<br>
<a href="https://github.com/hniman135/RaspberryDashboard/"><img src="https://img.shields.io/github/repo-size/hniman135/RaspberryDashboard?color=important" alt="License Badge"/></a>
<a href="https://github.com/hniman135/RaspberryDashboard/"><img src="https://img.shields.io/tokei/lines/github/hniman135/RaspberryDashboard?color=yellowgreen" alt="License Badge"/></a>
<a href="https://github.com/hniman135/RaspberryDashboard/releases"><img src="https://img.shields.io/github/v/release/hniman135/RaspberryDashboard?color=success" alt="License Badge"/></a>
<a href="https://github.com/hniman135/RaspberryDashboard/commits"><img src="https://img.shields.io/github/last-commit/hniman135/RaspberryDashboard" alt="License Badge"/></a>
</div>
<br>
<p align="center"><a href="https://github.com/hniman135/RaspberryDashboard/issues">Report a bug</a> | <a href="https://github.com/hniman135/RaspberryDashboard/discussions">Request a new feature</a> | <a href="https://github.com/hniman135/RaspberryDashboard/pulls">Help develop this project</a></p>
...
- Protected access with password login ([configure password](https://github.com/hniman135/RaspberryDashboard#configure-password-manually))
- Shutdown / Reboot your Raspberry Pi with scheduling options ([setup instructions](https://github.com/hniman135/RaspberryDashboard#enable-shutdown--reboot-optional))
...
```bash
wget -O install.sh https://github.com/hniman135/RaspberryDashboard/raw/release/installer.sh
bash install.sh
```
...
- clone the project into your web folder:<br>`git clone https://github.com/hniman135/RaspberryDashboard.git /var/www/html/<your_subfolder_name>`<br>(replace `<your_subfolder_name>` with a name of your choice accordingly, you can also rename this base folder at any time afterwards)
...
- in case of problems: please comment on [#12](https://github.com/hniman135/RaspberryDashboard/issues/12) (or [new issue](https://github.com/hniman135/RaspberryDashboard/issues/new))
...
- Please be aware that there is a **more user-friendly** way now by using the dashboards options modal. However, the following manual way of changing the password might be helpful
  - in case of wrong permissions (user `www-data` cannot change settings for you - [see issue #22](https://github.com/hniman135/RaspberryDashboard/issues/22) or [read here](https://github.com/hniman135/RaspberryDashboard#valid-permissions) for help and instructions to solve)
