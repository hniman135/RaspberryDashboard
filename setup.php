...
if(isset($_POST["complete"])){
  ...
  if($config->get("general.initialsetup")=="0"){
    ...
    if(isset($_POST["pw"])){
      ...
      echo "Setup error - no password specified. Please create an issue <a href='https://github.com/hniman135/RaspberryDashboard/issues/new' target='blank'>here</a>.";
      exit();
    }
            ...
            <div class="multisteps-form__content">
              <div class="form-row mt-4">
                ...
                <div class="list-group mb-3" style="width: 100%">
                  <a href="https://github.com/hniman135/RaspberryDashboard#valid-permissions" class="list-group-item list-group-item-action list-group-item-<?=$pclass0;?>">
...
<footer class="my-5 py-3 text-muted text-center text-small">
  <p class="mb-1"><a href="https://github.com/hniman135/RaspberryDashboard">RPi Dashboard</a> by <a href="https://github.com/hniman135">@hniman135</a></p>
  <ul class="list-inline">
    <li class="list-inline-item"><a href="https://github.com/hniman135/RaspberryDashboard/issues">Issues</a></li>
    <li class="list-inline-item"><a href="https://github.com/hniman135/RaspberryDashboard/blob/master/README.md">Readme</a></li>
    <li class="list-inline-item"><a href="https://github.com/hniman135/RaspberryDashboard/blob/master/CHANGELOG.md">Changelog</a></li>
  </ul>
</footer>
    ...
    if(data.responseText=="1"){
      ...
      if(data.responseText=="perm_error"){
        if (confirm(("Config file (local.config) exists but could not be modified. Required permissions are not set correctly.\nShow help?"))){
          window.open('https://github.com/hniman135/RaspberryDashboard#valid-permissions');
        }
      }
