          ...
          <div class="accordion-item">
            ...
            <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
              <div class="accordion-body">
                ...
                <ul><li>live page title with hostname + status of monitored RPi</li><li>overhauled project documentation / readme</li><li><a href='https://github.com/hniman135/RaspberryDashboard/releases'>Stay updated here</a></li><li><i><a href="CHANGELOG.md">All changes</a></i></li></ul>
...
<!-- <footer style="line-height: 40px; margin-top: 10px;" class="border-top py-1">
  <div class="container text-center">
    RPi Dashboard v1.1.5 <span class="text-muted">(Nov 2023)</span> <span id="dot">&middot;</span> <span id="notf" class="text-success">See the <a href="https://github.com/hniman135/RaspberryDashboard/releases">Github releases</a> for updates!</span><br />
    <button class="btn btn-secondary mb-2" onclick="$('#exampleModal').modal('show');"><i class="bi bi-gear"></i>&nbsp;Options</button>
    <hr style="margin-top: 0; margin-bottom: 0;">
    hniman135&nbsp;<a href="https://github.com/hniman135"><i class="bi bi-github"></i></a> &middot; <span class="text-muted">2018 - 2023</span>
  </div>
</footer> -->
<!-- End Footer -->
